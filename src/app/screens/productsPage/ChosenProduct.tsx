...
import { setChosenProduct, setShowroom } from "./slice";
import { retrieveChosenProduct, retrieveShowroom } from "./selector";
...
const actionDispatch = (dispatch: Dispatch) => ({
  setShowroom: (data: Member) => dispatch(setShowroom(data)),
